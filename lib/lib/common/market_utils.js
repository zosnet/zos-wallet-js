...
var MarketUtils = {
    ...
    getFeedPrice: function getFeedPrice(settlement_price) {
        ...
        var quoteAsset = _es.ChainStore.getAsset(settlement_price.getIn(["quote", "asset_id"]));
        var baseAsset = _es.ChainStore.getAsset(settlement_price.getIn(["base", "asset_id"]));
